...
<header>
    <div class="headerContainer">
        <h1><a href="">ZOO <span>co</span></a></h1>
        <div id="navcontainer">
            <ul id="navlist">
...
%>		  <link rel="stylesheet" href="style.css">
		<div id="pr" ><p bgcolor="green">
		POSTED BY:<% out.println(rs.getInt(1)); %><br>
                 SUBJECT:<% out.println(rs.getString(3)); %><br>
		QUERY:<% out.println(rs.getString(4)); %><br>
		</p>
