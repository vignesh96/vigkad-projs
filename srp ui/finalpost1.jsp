...
PreparedStatement ps=con.prepareStatement("select * from finpost where category='studies'");%>
...
%>		  <link rel="stylesheet" href="style.css">
		...
		<input type="hidden" value="studies" name="categ">
		POSTED BY:<% out.println(regno));%><input type="hidden" name="preg" value="<% out.println(regno); %>" readonly><br>
        SUBJECT: <% out.println(subj); %> <input type="hidden" name="subj" value="<% out.println(subj);%>" readonly><br>
		QUERY: <% out.println(prob); %> <input type="hidden" name="query" value="<% out.println(prob); %>" readonly><br>
		</p>
		<input type="text" name="comment" placeholder="Leave your comments..."><br>
		<input type="submit" value="comment"><br><br></div>
		</form>
		
		<form name="form" action="view.jsp" method="post">
			<input type="hidden" name="preg" value="<% out.println(regno); %>" >
			<input type="hidden" name="cat" value="<% out.println(cat); %>" >
			<input type="hidden" name="subj" value="<% out.println(subj); %>" >
